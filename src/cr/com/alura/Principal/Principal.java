...
public class Principal {
	...
	public static ImageIcon icono = new ImageIcon(
			"C:\\Users\\jairo O\\git\\repository2\\Conversor-de-moneda-en-java\\src\\cr\\com\\alura\\Principal\\carita.png");
	...
	public static void main(String[] args) {
		...
		try {
			...
			case "Conversor de moneda": {
				try {
					int input = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese valor para convertir",
							"Bienvenido", JOptionPane.PLAIN_MESSAGE));
					double valorRecibido = (double) input;
					monedas.ConvertirMonedas(valorRecibido);
				} catch (Exception e) {
					JOptionPane.showMessageDialog(null, "Ingresa la información y selecciona ok", "Titulo",
				...
				if (JOptionPane.OK_OPTION == seleccion || JOptionPane.CANCEL_OPTION == seleccion) {
					...
					JOptionPane.showMessageDialog(null, "Programa terminado", "Titulo", JOptionPane.PLAIN_MESSAGE,
							icono);
					System.exit(0);
				}
			}
			...
			case "Conversor de distancia": {
				...
				if (JOptionPane.OK_OPTION == seleccion || JOptionPane.CANCEL_OPTION == seleccion) {
					...
					JOptionPane.showMessageDialog(null, "Programa terminado", "Titulo", JOptionPane.PLAIN_MESSAGE,icono);
					System.exit(0);
				}
